  ...
  container.innerHTML = `
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 animate-in-delay-1">
      ${costos?.map(c => {
        ...
        return `
        <div class="card-elevated p-5 relative group">
        ...
        <div class="col-span-full empty-state">
          <div class="empty-state-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><path d="M14 8h-4"/><path d="M14 12h-4"/><path d="M14 16h-4"/></svg>
          </div>
          <h3>No hay costos fijos</h3>
          <p>Agrega tus gastos fijos mensuales para calcular el costo por hora.</p>
        </div>
      `}
    </div>
  `;
